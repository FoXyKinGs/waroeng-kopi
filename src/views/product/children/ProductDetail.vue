...
.container
  .product
    ...
    .description
      p.name Hario cafe press slim grey 240ML
      p.product-by UbruKopi
      .rating start
      p.price Rp 240.000
      .cart-system
        .qty
      ...
      .about-product
        p French Press dari Hario berbahan dasar kaca berwarna abu-abu di desain dengan bentuk yang ramping dan menarik. sangat cocok untuk membuat 1-2 gelas kopi.
  .more-information
</template>
